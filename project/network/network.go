...
type Message struct {
	//TODO: must make the struct
}



func ConnectToNetwork(messageTx chan, messageRx chan) {
...
func BroadcastMessage(message Message, messageTx chan) {
	//Sending the message
	messageTx <- message
}

func MessageRecieved() (Message, messageRx chan) {
	message := <- messageRx
	return
}
