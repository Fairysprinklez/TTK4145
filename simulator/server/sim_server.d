...
final class SimulationState {
    this(bool randomStart, int numFloors){
...
void main(string[] args){
    ...
    auto state = new SimulationState(randomStart, numFloors);
    void printState(){
        version(Posix){
    ...
    while(true){
        ...
        receive(
            ...
            (ReloadConfig r){
                (args.length == 2 ? args[1] : "simulator.con").loadConfig;
                state = new SimulationState(randomStart, numFloors);
            },
